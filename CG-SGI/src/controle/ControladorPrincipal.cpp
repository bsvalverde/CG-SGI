...
void ControladorPrincipal::inserirObjeto(const String& nome, const QList<Ponto>& pontos, const QColor& cor) {
	this->controladorMundo->inserirObjeto(nome, pontos, cor);
	this->controladorUI->atualizarCena(this->controladorMundo->getObjetosNormalizados());
}
